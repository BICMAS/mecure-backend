...
import { getUser, createUser, updateUser, bulkUpload, getAllUsers, getCurrentOrgUsers, listOrganizations, blockUser, unblockUser, deleteUser } from '../controllers/UserController.js';
...
userRouter.get('/organizations', authenticateToken, requireRole(['SUPER_ADMIN']), listOrganizations);
