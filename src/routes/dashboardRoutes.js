...
import { getHRDashboard, getAllLearnersCourseTracking, getHrActivityReport, getLearnerCourseTracking, getLearnerDashboard, getSuperAdminDashboard } from '../controllers/DashboardController.js';
import { authenticateToken, requireRole } from '../middleware/authMiddleware.js';
import { log } from 'console';

const dashboardRouter = Router();
dashboardRouter.get('/hr', authenticateToken, requireRole('HR_MANAGER'), getHRDashboard);
dashboardRouter.get('/hr/activity-report', authenticateToken, requireRole('HR_MANAGER'), getHrActivityReport);
